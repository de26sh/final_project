                                        ...
                                        <div class="direct-chat-contacts">
                                            <ul class="contacts-list">
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{asset('assets/img/user1-128x128.jpg')}}" alt="User Avatar" />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{asset('assets/img/user7-128x128.jpg')}}" alt="User Avatar" />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{asset('assets/img/user3-128x128.jpg')}}" alt="User Avatar" />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{asset('assets/img/user5-128x128.jpg')}}" alt="User Avatar" />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{asset('assets/img/user6-128x128.jpg')}}" alt="User Avatar" />
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{asset('assets/img/user8-128x128.jpg')}}" alt="User Avatar" />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row text-center m-1">
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user1-128x128.jpg')}}"
                                                    alt="User Image" />
                                            ...
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user7-128x128.jpg')}}"
                                                    alt="User Image" />
                                                <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                    href="#">
                                                    Jane
                                            ...
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user6-128x128.jpg')}}"
                                                    alt="User Image" />
                                                <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                    href="#">
                                                    John
                                            ...
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user2-160x160.jpg')}}"
                                                    alt="User Image" />
                                                <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                    href="#">
                                                    Alexander
                                            ...
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user5-128x128.jpg')}}"
                                                    alt="User Image" />
                                                <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                    href="#">
                                                    Sarah
                                            ...
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user4-128x128.jpg')}}"
                                                    alt="User Image" />
                                                <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                    href="#">
                                                    Nora
                                            ...
                                            <div class="col-3 p-2">
                                                <img class="img-fluid rounded-circle" src="{{asset('assets/img/user3-128x128.jpg')}}"
                                                    alt="User Image" />
                                                <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                    href="#">
                                                    Nadia
