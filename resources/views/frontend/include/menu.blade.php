                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{ route('frontend.index') }}"><img
                                    ...
                                    style="width: 110px !important" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                    ...
                    <div class="col-md-12 align-self-center">
                        <div class="main-menu manu-color-white">
                            <ul>
                                ...
                                <li class="dropdown"><a href="#">Family <i class="ion-ios-arrow-down"></i></a>
                                    <ul class="sub-menu">
                                        @foreach ($family as $fm)
                                            <li><a
                                                    href="{{ route('family.products', $fm->id) }}">{{ $fm->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
