...
<head>
    ...
    <link rel="icon" href="{{asset('frontend/assets/images/favicon/favicon.png')}}" sizes="192x192" />
                                    ...
                                    <ul class="mega-menu d-block">
                                        ...
                                        <li>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="{{asset('frontend/assets/images/banner/3.jpg')}}" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="{{asset('frontend/assets/images/banner/4.jpg')}}" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend/assets/images/product-image/1.jpg')}}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend/assets/images/product-image/2.jpg')}}" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend/assets/images/product-image/3.jpg')}}" alt="Cart product Image"></a>
                        <div class="content">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item slider-height-2 swiper-slide d-flex">
                    <div class="hero-bg-image">
                        <img src="{{asset('frontend/assets/images/slider-image/slider-2-1.jpg')}}" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-12" data-aos="fade-up" data-aos-delay="600">
                    <div class="banner-2">
                        <img src="{{asset('frontend/assets/images/banner/7.jpg')}}" alt="" />
                        <div class="info justify-content-start">
                            <div class="content align-self-center">
                                <h3 class="title">
                            ...
                            <div class="row">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/2.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/4.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/8.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/10.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/12.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                            <div class="actions">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up" data-aos-delay="600">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="{{asset('frontend/assets/images/product-image/13.jpg')}}" alt="Product" />
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/14.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                            </span>
                                            <div class="actions">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 " data-aos="fade-up" data-aos-delay="800">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="{{asset('frontend/assets/images/product-image/15.jpg')}}" alt="Product" />
                                                <img class="hover-image" src="{{asset('frontend/assets/images/product-image/16.jpg')}}" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <a href="shop-left-sidebar.html" class="banner-3">
                        <img src="{{asset('frontend/assets/images/banner/1.jpg')}}" alt="" />
                ...
                <div class="col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="200">
                    <a href="shop-left-sidebar.html" class="banner-3">
                        <img src="{{asset('frontend/assets/images/banner/2.jpg')}}" alt="" />
                        <div class="info justify-content-start">
                            <div class="content align-self-center">
                                <h3 class="title">
                ...
                <div class="swiper-wrapper">
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend/assets/images/blog-image/1.jpg')}}" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend/assets/images/blog-image/2.jpg')}}" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend/assets/images/blog-image/3.jpg')}}" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend/assets/images/blog-image/4.jpg')}}" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                            ...
                            <div class="swiper-container gallery-top mb-20px">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset('frontend/assets/images/product-image/1.jpg')}}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset('frontend/assets/images/product-image/2.jpg')}}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset('frontend/assets/images/product-image/3.jpg')}}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset('frontend/assets/images/product-image/4.jpg')}}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset('frontend/assets/images/product-image/5.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
